...
class __TwigTemplate_f657dc3c1be8766abf633294009b652b extends Template
{
          ...
          <details class=\"js-form-wrapper form-wrapper module-list__module-details claro-details\" id=\"";
            ...
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["module"], "links", [], "any", false, false, true, 61)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["link_type"]) {
                    // line 64
                    yield "                      ";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, (($_v0 = CoreExtension::getAttribute($this->env, $this->source, $context["module"], "links", [], "any", false, false, true, 64)) && is_array($_v0) || $_v0 instanceof ArrayAccess && in_array($_v0::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v0[(($_v1 = $context["link_type"]) instanceof \Stringable ? (string) $_v1 : $_v1)] ?? null) : CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["module"], "links", [], "any", false, false, true, 64), $context["link_type"], [], "array", false, false, true, 64)), "html", null, true);
                    yield "
                    ";
                }
...
";
    ...
    {
        return array (  168 => 74,  157 => 68,  153 => 66,  144 => 64,  140 => 63,  137 => 62,  135 => 61,  132 => 60,  126 => 58,  123 => 57,  117 => 55,  114 => 54,  108 => 52,  106 => 51,  102 => 50,  93 => 46,  89 => 45,  79 => 42,  73 => 39,  67 => 37,  63 => 36,  56 => 32,  52 => 31,  48 => 30,  43 => 27,);
    }
